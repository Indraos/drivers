...
setting the pricing terms between them. ---\tocite
\end{quote}
 This chapter presents significant frictions in a market for urban mobility in Jakarta, Indonesia. We use quantitative results to present significant deviation from driver earnings maximization, and code free-text answers to gather evidence for reasons outside of earnings maximization.
\section{Survey}
