...
\subsection{Matching}
General matching is solved in the OR literature. \tocite(dynamic stochastic matching with limited time)
...
\subsubsection{Driver Behavior}
There are also study that do not view information design as a platform question. 
