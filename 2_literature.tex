...
\subsection{Surveys in Labour Economics}
Surveys have been used in labor economics 
...
Some platforms scrape data from platforms, such as studies on platform competition in New York \tocite (rosaia) and a consumer surplus comparison of taxi and ridesourcing \cite (shapiro). Similarly, \tocite (peaking under the hood) uses large-scale simulation of apps.
...
In contrast to cheap talk, Information Design models allow the sender to commit to rules for which information they reveal \tocite (kamenica gentzkow, also annual reviews). This can have profound implications for the outcome o
