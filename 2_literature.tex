...
\epigraph{[Traffic participants] make route choices based on their private beliefs about the state and other populations’ signals. The question then arises, \enquote{How does the presence of asymmetric and incomplete information affect the [participants]’ equilibrium route choices and costs?}}{\cite{Wu2021}}
