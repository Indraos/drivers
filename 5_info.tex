...
\begin{cor}\label{cor:commitmentlack}
	With a lack of commitment, the driver
\end{cor}
...
For our last statement, we will need a slightly more involved model. Several agents