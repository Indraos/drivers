...
For our last statement, we will need a more general model. There are $n$ drivers, which learn a state $\theta \in \{0,1 , 2,\dots, n\}$. Drivers get a utility $1-\varepsilon$ if matched to a ride and they get a utility of $-\varepsilon$ if not matched. We assume that $n$ is large, and that the distribution function is 

\section{Conclusion}
This section presented a theoretical model 