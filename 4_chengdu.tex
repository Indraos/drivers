...
10 Million orders. An order consists of an origin-destination pair, a timestamp for beginning and end, an identifier for the driver that took the order, and a number of \emph{reward units}. We argue below that reward units are a constant factor and exemplify this with a good fit of our model in \autoref{chap:chengduregress}.
...
We also use the leaderboard's reinforcement challenge leaderboard. It is reproduced from \url{
